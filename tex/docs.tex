...
%----------------------------------metadata------------------------------------
\title{\normalsize \textsc{``This is my design."} % subtitle
	   \\[2.0cm] % 2cm spacing
	   \HRule{1pt} \\ [0.2cm] % upper rule
	   \LARGE \textbf{\uppercase{Pavlov, Poisson and Parzen}} % title
	   \HRule{1pt} \\ [3cm] % lower rule + 0.5cm spacing
